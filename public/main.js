...
var author$project$Config$config = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('title', 'UpSoRok')
		]));
...
var author$project$Config$getConfig = function (key) {
	var _n0 = A2(elm$core$Dict$get, key, author$project$Config$config);
	if (_n0.$ === 'Just') {
		var value = _n0.a;
		return value;
	} else {
...
var author$project$View$Categories$categoriesSection = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('main-block light-bg')
		]),
	_List_fromArray(
		[
			A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('add-listing-wrap')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													elm$html$Html$text('Reach millions of People')
												])),
											A2(
											elm$html$Html$p,
											_List_Nil,
											_List_fromArray(
												[
													elm$html$Html$text('Add your Business infront of millions and earn 3x profits from our listing')
												]))
										]))
								]))
						])),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('featured-btn-wrap')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('ti-plus')
														]),
													_List_Nil),
													elm$html$Html$text('ADD LISTING')
												]))
										]))
								]))
						]))
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('styled-heading')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													elm$html$Html$text('Featured Places')
												]))
										]))
								]))
						])),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('col-md-4 featured-responsive')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('featured-place-wrap')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$href('detail.html')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$src('images/featured1.jpg'),
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('featured-rating-orange')
														]),
													_List_fromArray(
														[
															elm$html$Html$text('6.5')
														])),
													A2(
													elm$html$Html$div,
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('featured-title-box')
														]),
													_List_fromArray(
														[
															A2(
															...
															_List_fromArray(
																[
																	elm$html$Html$text('Burger & Lobster')
																])),
															A2(
															elm$html$Html$p,
															_List_Nil,
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$class('icon-location-pin')
																				]),
																			_List_Nil),
																			A2(
																			elm$html$Html$p,
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$text('1301 Avenue, Brooklyn, NY 11230')
																				]))
																		])),
																	A2(
																	elm$html$Html$li,
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$class('icon-screen-smartphone')
																				]),
																			_List_Nil),
																			A2(
																			elm$html$Html$p,
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$text('+44 20 7336 8898')
																				]))
																		])),
																	A2(
																	elm$html$Html$li,
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$class('icon-link')
																				]),
																			_List_Nil),
																			A2(
																			elm$html$Html$p,
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$text('https://burgerandlobster.com')
																				]))
																		]))
																])),
															A2(
															...
															_List_fromArray(
																[
																	elm$html$Html$Attributes$class('bottom-icons')
																]),
															_List_fromArray(
																[
																	A2(
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('closed-now')
																		]),
																	_List_fromArray(
																		[
																			elm$html$Html$text('CLOSED NOW')
																		])),
																	A2(
																	elm$html$Html$span,
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('ti-heart')
																		]),
																	_List_Nil),
																	A2(
																	elm$html$Html$span,
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('ti-bookmark')
																		]),
																	_List_Nil)
																]))
														]))
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$src('images/featured2.jpg'),
															elm$html$Html$Attributes$class('img-fluid'),
															elm$html$Html$Attributes$alt('#')
														]),
													_List_Nil),
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('featured-rating-green')
														]),
													_List_fromArray(
														[
															elm$html$Html$text('9.5')
														])),
													A2(
													elm$html$Html$div,
													_List_fromArray(
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	elm$html$Html$text('Joe’s Shanghai')
																])),
															A2(
															elm$html$Html$p,
															_List_Nil,
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$src('images/featured3.jpg'),
															elm$html$Html$Attributes$class('img-fluid'),
															elm$html$Html$Attributes$alt('#')
														]),
													_List_Nil),
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('featured-rating')
														]),
													_List_fromArray(
														[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	elm$html$Html$text('Tasty Hand-Pulled Noodles')
																])),
															A2(
															elm$html$Html$p,
															_List_Nil,
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$Attributes$class('open-now')
																		]),
																	_List_fromArray(
																		[
																			elm$html$Html$text('OPEN NOW')
																		])),
																	A2(
																	elm$html$Html$span,
																	_List_fromArray(
...
var author$project$View$FindPlaces$findPlacesSection = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('main-block')
		]),
	_List_fromArray(
		[
			A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text('What do you need to find?')
												]))
										]))
								]))
						])),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('find-place-img_wrap')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('effect-ruby')
														]),
													_List_fromArray(
														[
															A2(
															...
															_List_fromArray(
																[
																	elm$html$Html$Attributes$src('images/find-place1.jpg'),
																	elm$html$Html$Attributes$class('img-fluid'),
																	elm$html$Html$Attributes$alt('img13')
																]),
															_List_Nil),
															A2(
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$text('385 Listings')
																		]))
																]))
														]))
												]))
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('row find-img-align')
										]),
									_List_fromArray(
										[
											A2(
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$src('images/find-place2.jpg'),
																					elm$html$Html$Attributes$class('img-fluid'),
																					elm$html$Html$Attributes$alt('img13')
																				]),
																			_List_Nil),
																			...
																			_List_fromArray(
																				[
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$text('Restaurants')
																						])),
																					A2(
																					elm$html$Html$p,
																					_List_Nil,
																					_List_fromArray(
																						[
																							elm$html$Html$text('210 Listings')
																						]))
																				]))
																		]))
																]))
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$src('images/find-place3.jpg'),
																					elm$html$Html$Attributes$class('img-fluid'),
																					elm$html$Html$Attributes$alt('img13')
																				]),
																			_List_Nil),
																			...
																			_List_fromArray(
																				[
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$text('114 Listings')
																						]))
																				]))
																		]))
																]))
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$src('images/find-place4.jpg'),
																					elm$html$Html$Attributes$class('img-fluid'),
																					elm$html$Html$Attributes$alt('img13')
																				]),
																			_List_Nil),
																			...
																			_List_fromArray(
																				[
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$text('577 Listings')
																						]))
																				]))
																		]))
																]))
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$src('images/find-place5.jpg'),
																					elm$html$Html$Attributes$class('img-fluid'),
																					elm$html$Html$Attributes$alt('img13')
																				]),
																			_List_Nil),
																			...
																			_List_fromArray(
																				[
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$text('Art & Culture')
																						])),
																					A2(
																					elm$html$Html$p,
																					_List_Nil,
																					_List_fromArray(
																						[
																							elm$html$Html$text('79 Listings')
																						]))
																				]))
																		]))
																]))
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$href(alink.link)
			]),
		_List_fromArray(
			[
				elm$html$Html$text(alink.name)
			]));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('icon-arrow-down')
								]),
							_List_Nil)
						])),
					A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('icon-menu')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('collapse navbar-collapse justify-content-end'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('#'),
											elm$html$Html$Attributes$class('btn btn-outline-light top-btn')
										]),
									_List_fromArray(
										[
											A2(
...
var author$project$View$Main$navMenu = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('bg transition')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('container-fluid fixed')
						]),
					_List_fromArray(
						[
							A2(
														...
														[
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$text('Discover great businesses')
																		])),
																	A2(
																	elm$html$Html$h5,
																	_List_Nil,
																	_List_fromArray(
																		[
																			elm$html$Html$text('Let\'s uncover the best places to eat, drink, and shop nearest to you.')
																		]))
																]))
														]))
												])),
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	elm$html$Html$Attributes$class('form-wrap mt-4')
																]),
															_List_fromArray(
																[
																	A2(
																	...
																	_List_fromArray(
																		[
																			...
																			A2(elm$html$Html$Attributes$attribute, 'aria-label', 'Basic example')
																		]),
																	_List_fromArray(
																		[
																			A2(
																			...
																			_List_fromArray(
																				[
																					...
																					elm$html$Html$Attributes$placeholder('What are your looking for?'),
																					elm$html$Html$Attributes$class('btn-group1')
																				]),
																			_List_Nil),
																			A2(
																			elm$html$Html$input,
																			_List_fromArray(
																				[
																					elm$html$Html$Attributes$type_('text'),
																					elm$html$Html$Attributes$placeholder('New york'),
																					elm$html$Html$Attributes$class('btn-group2')
																				]),
																			_List_Nil),
																			A2(
																			elm$html$Html$button,
																			_List_fromArray(
																				[
																					...
																					elm$html$Html$Attributes$class('btn-form')
																				]),
																			_List_fromArray(
																				[
																					A2(
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$Attributes$class('icon-magnifier search-icon')
																						]),
																					_List_Nil),
																					...
																					_List_fromArray(
																						[
																							elm$html$Html$Attributes$class('pe-7s-angle-right')
																						]),
																					_List_Nil)
																				]))
																		]))
															...
															_List_fromArray(
																[
																	elm$html$Html$Attributes$class('slider-link')
																]),
															_List_fromArray(
																[
																	A2(
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$text('Browse Popular')
																		])),
																	A2(
																	elm$html$Html$span,
																	_List_Nil,
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$text('Recently Added')
																		]))
																]))
														]))
												]))
...
var author$project$View$Main$view = function (model) {
	return {
		...
		title: author$project$Config$getConfig('title')
	};
};
